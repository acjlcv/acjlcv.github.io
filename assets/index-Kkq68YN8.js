...
## reflection
This project was pretty fun as it was one of my first hands on experience with pytorch model training. I learned a lot how Nerual Networks worked and in particular the UNet structure and diffusion models.`,A=`---
...
### reflection
pretty fun project over all and learned more the applications of affine transformations in computer vision.`,S=`---
...
### reflection
pretty fun project overall. learned how frequencies worked and basically how photoshop works with masking. made some fun references to some of my favorite animes :).`,H=`---
...
`;function f(i){const n=i.split(`
`),s={};let r=0;if(n[0]?.trim()==="---")for(let t=1;t<n.length;t++){if(n[t].trim()==="---"){r=t+1;break}const a=n[t].indexOf(":");if(a!==-1){const o=n[t].slice(0,a).trim(),y=n[t].slice(a+1).trim();s[o]=y}}return{data:s,content:n.slice(r).join(`
`).trim()}}function C(i){const n=i.split("/");return n[n.length-1].replace(/\.md$/,"")}const j=Object.assign({"/content/misc/first-post.md":T,"/content/projects/diffusion.md":z,"/content/projects/face-morph.md":A,"/content/projects/filters-and-frequencies.md":S,"/content/projects/image-stitching.md":H,"/content/projects/nerf.md":M,"/content/projects/prokudin-gorskii.md":P});function w(i,n){const s=[];for(const[r,t]of Object.entries(j)){if(!r.startsWith(`/content/${i}/`))continue;const{data:a}=f(t),o=C(r);s.push({title:a.title??o,date:a.date??"",slug:o})}return s.sort((r,t)=>{const a=new Date(r.date.replace(/\./g,"-")).getTime();return new Date(t.date.replace(/\./g,"-")).getTime()-a}),s}function b(i,n){const s=`/content/${i}/${n}.md`,r=j[s];if(!r)return;const{data:t,content:a}=f(r);return{title:t.title??n,date:t.date??"",slug:n,content:a}}function F(i){return w("projects")}function L(i){return b("projects",i)}function D(i){return w("misc")}function R(i){return b("misc",i)}function q(){const i=F();return e.jsxs("div",{className:"content",style:{animation:"fadeIn 0.8s ease-out"},children:[e.jsx("header",{className:"mb-4",children:e.jsx("h1",{children:"Projects"})}),e.jsx("hr",{}),e.jsxs("div",{className:"grid grid-cols-[1fr_auto] text-sm",children:[e.jsx("div",{children:e.jsx("ul",{className:"space-y-1",children:i.map(n=>e.jsx("li",{children:e.jsx(l,{to:`/projects/${n.slug}`,className:"hover:underline",children:n.title})},n.slug))})}),e.jsx("div",{className:"dates-list min-w-20 text-[#666]",children:e.jsx("ul",{className:"font-mono",children:i.map(n=>e.jsx("li",{children:n.date},n.slug))})})]})]})}function U(){const{slug:i}=g(),n=i?L(i):void 0;return n?e.jsxs("div",{className:"content",children:[e.jsxs("div",{className:"post",children:[e.jsx("h1",{className:"title",children:n.title}),e.jsx("p",{className:"font-mono text-sm text-zinc-500",children:n.date})]}),e.jsx("hr",{}),e.jsx("article",{className:"prose prose-zinc dark:prose-invert mt-4",children:e.jsx(p,{remarkPlugins:[c,u],rehypePlugins:[m,h],children:n.content})}),e.jsx("br",{})]}):e.jsxs("div",{className:"content",style:{animation:"fadeIn 0.8s ease-out"},children:[e.jsx("header",{className:"mb-4",children:e.jsx("h1",{children:"Project not found"})}),e.jsx("hr",{}),e.jsx("p",{className:"text-sm text-zinc-500",children:e.jsx(l,{to:"/projects",className:"hover:underline",children:"Back to projects"})})]})}function B(){const i=D();return e.jsxs("div",{className:"content",style:{animation:"fadeIn 0.8s ease-out"},children:[e.jsx("header",{className:"mb-4",children:e.jsx("h1",{children:"Misc."})}),e.jsx("hr",{}),e.jsxs("div",{className:"grid grid-cols-[1fr_auto] text-sm",children:[e.jsx("div",{children:e.jsx("ul",{className:"space-y-1",children:i.map(n=>e.jsx("li",{children:e.jsx(l,{to:`/misc/${n.slug}`,className:"hover:underline",children:n.title})},n.slug))})}),e.jsx("div",{className:"dates-list min-w-20 text-[#666]",children:e.jsx("ul",{className:"font-mono",children:i.map(n=>e.jsx("li",{children:n.date},n.slug))})})]})]})}function E(){const{slug:i}=g(),n=i?R(i):void 0;return n?(console.log(n),e.jsxs("div",{className:"content",children:[e.jsxs("div",{className:"post",children:[e.jsx("h1",{className:"title",children:n.title}),e.jsx("p",{className:"font-mono text-sm text-zinc-500",children:n.date})]}),e.jsx("hr",{}),e.jsx("article",{className:"prose prose-zinc dark:prose-invert mt-4",children:e.jsx(p,{remarkPlugins:[c,u],rehypePlugins:[m,h],children:n.content})}),e.jsx("br",{})]})):e.jsxs("div",{className:"content",style:{animation:"fadeIn 0.8s ease-out"},children:[e.jsx("header",{className:"mb-4",children:e.jsx("h1",{children:"Post not found"})}),e.jsx("hr",{}),e.jsx("p",{className:"text-sm text-zinc-500",children:e.jsx(l,{to:"/misc",className:"hover:underline",children:"Back to misc"})})]})}function G(){return e.jsxs("div",{className:"content",style:{animation:"fadeIn 0.8s ease-out"},children:[e.jsx("header",{className:"mb-4",children:e.jsx("h1",{children:"Invalid URL"})}),e.jsx("hr",{}),e.jsx("p",{className:"text-sm text-zinc-500",children:e.jsx(l,{to:"/",className:"hover:underline",children:"Back to home"})})]})}function W(){return e.jsxs(N,{children:[e.jsxs(k,{children:[e.jsx(d,{path:"/",element:e.jsx(v,{to:"/home",replace:!0})}),e.jsx(d,{path:"/home",element:e.jsx($,{})}),e.jsx(d,{path:"/projects",element:e.jsx(q,{})}),e.jsx(d,{path:"/projects/:slug",element:e.jsx(U,{})}),e.jsx(d,{path:"/misc",element:e.jsx(B,{})}),e.jsx(d,{path:"/misc/:slug",element:e.jsx(E,{})}),e.jsx(d,{path:"/*",element:e.jsx(G,{})})]}),e.jsx("div",{className:"grow",children:e.jsxs("footer",{className:"footer",children:[e.jsxs("ul",{className:"flex gap-4",children:[e.jsx("li",{children:e.jsx("a",{href:"/#/home",children:"home"})}),e.jsx("li",{children:e.jsx("a",{href:"/#/projects",children:"projects"})}),e.jsx("li",{children:e.jsx("a",{href:"/#/misc",children:"misc"})})]}),e.jsxs("ul",{className:"flex gap-4",children:[e.jsx("li",{children:e.jsx("a",{href:"https://linkedin.com/in/arnold-cai",target:"_blank",rel:"noopener noreferrer",children:"linkedin"})}),e.jsx("li",{children:e.jsx("a",{href:"https://github.com/acjlcv",target:"_blank",rel:"noopener noreferrer",children:"github"})}),e.jsx("li",{children:e.jsx("a",{href:"https://x.com/arncai",target:"_blank",rel:"noopener noreferrer",children:"x"})})]})]})})]})}x.createRoot(document.getElementById("root")).render(e.jsx(_.StrictMode,{children:e.jsx(I,{children:e.jsx(W,{})})}));
